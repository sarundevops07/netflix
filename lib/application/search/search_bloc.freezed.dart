...
/// @nodoc
mixin _$SearchState {
  List<SearchResultsModel> get searchResultsModel =>
      throw _privateConstructorUsedError;
...
class _$SearchStateCopyWithImpl<$Res, $Val extends SearchState>
  ...
  @override
  $Res call({
    Object? searchResultsModel = null,
    Object? idleList = null,
    Object? isLoading = null,
    Object? isError = null,
  }) {
    return _then(_value.copyWith(
      searchResultsModel: null == searchResultsModel
          ? _value.searchResultsModel
          : searchResultsModel // ignore: cast_nullable_to_non_nullable
              as List<SearchResultsModel>,
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<SearchResultsModel> searchResultsModel,
      required final List<DownloadsModel> idleList,
      required this.isLoading,
      required this.isError})
      : _searchResultsModel = searchResultsModel,
        _idleList = idleList;

  final List<SearchResultsModel> _searchResultsModel;
  @override
  List<SearchResultsModel> get searchResultsModel {
    if (_searchResultsModel is EqualUnmodifiableListView)
      return _searchResultsModel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_searchResultsModel);
  }
  ...
  @override
  String toString() {
    return 'SearchState(searchResultsModel: $searchResultsModel, idleList: $idleList, isLoading: $isLoading, isError: $isError)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._searchResultsModel, _searchResultsModel) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_searchResultsModel),
